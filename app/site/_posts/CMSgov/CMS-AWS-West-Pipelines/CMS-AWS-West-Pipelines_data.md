---
layout: repo-report
title: Open Source at CMS Metrics Report for CMS-AWS-West-Pipelines | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/CMS-AWS-West-Pipelines/predominant_langs_CMS-AWS-West-Pipelines_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/CMS-AWS-West-Pipelines/language_summary_CMS-AWS-West-Pipelines_data.svg", title: "Language Summary" %}
</div>