---
layout: repo-report
title: Open Source at CMS Metrics Report for qpp-shared-api-versioning-node | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/qpp-shared-api-versioning-node/predominant_langs_qpp-shared-api-versioning-node_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/qpp-shared-api-versioning-node/language_summary_qpp-shared-api-versioning-node_data.svg", title: "Language Summary" %}
</div>