---
layout: repo-report
title: Open Source at CMS Metrics Report for mint-app | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/mint-app/predominant_langs_mint-app_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/mint-app/language_summary_mint-app_data.svg", title: "Language Summary" %}
</div>