---
layout: repo-report
title: Open Source at CMS Metrics Report for ab2d-sample-client-powershell | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/ab2d-sample-client-powershell/predominant_langs_ab2d-sample-client-powershell_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/ab2d-sample-client-powershell/language_summary_ab2d-sample-client-powershell_data.svg", title: "Language Summary" %}
</div>