---
layout: repo-report
title: Open Source at CMS Metrics Report for HealthCare.gov-Styleguide | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/HealthCare.gov-Styleguide/predominant_langs_HealthCare.gov-Styleguide_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/HealthCare.gov-Styleguide/language_summary_HealthCare.gov-Styleguide_data.svg", title: "Language Summary" %}
</div>