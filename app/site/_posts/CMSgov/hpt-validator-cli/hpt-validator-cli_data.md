---
layout: repo-report
title: Open Source at CMS Metrics Report for hpt-validator-cli | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/hpt-validator-cli/predominant_langs_hpt-validator-cli_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/hpt-validator-cli/language_summary_hpt-validator-cli_data.svg", title: "Language Summary" %}
</div>