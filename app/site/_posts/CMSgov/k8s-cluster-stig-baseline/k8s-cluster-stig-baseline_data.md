---
layout: repo-report
title: Open Source at CMS Metrics Report for k8s-cluster-stig-baseline | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/k8s-cluster-stig-baseline/predominant_langs_k8s-cluster-stig-baseline_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/k8s-cluster-stig-baseline/language_summary_k8s-cluster-stig-baseline_data.svg", title: "Language Summary" %}
</div>