---
layout: repo-report
title: Open Source at CMS Metrics Report for qpp-measures-data | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/qpp-measures-data/predominant_langs_qpp-measures-data_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/qpp-measures-data/language_summary_qpp-measures-data_data.svg", title: "Language Summary" %}
</div>