---
layout: repo-report
title: Open Source at CMS Metrics Report for oracle-database-19c-cis-baseline | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/oracle-database-19c-cis-baseline/predominant_langs_oracle-database-19c-cis-baseline_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/oracle-database-19c-cis-baseline/language_summary_oracle-database-19c-cis-baseline_data.svg", title: "Language Summary" %}
</div>