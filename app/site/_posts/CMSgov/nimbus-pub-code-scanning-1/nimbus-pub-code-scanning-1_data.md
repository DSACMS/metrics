---
layout: repo-report
title: Open Source at CMS Metrics Report for nimbus-pub-code-scanning-1 | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/nimbus-pub-code-scanning-1/predominant_langs_nimbus-pub-code-scanning-1_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/nimbus-pub-code-scanning-1/language_summary_nimbus-pub-code-scanning-1_data.svg", title: "Language Summary" %}
</div>