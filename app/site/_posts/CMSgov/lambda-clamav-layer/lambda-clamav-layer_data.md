---
layout: repo-report
title: Open Source at CMS Metrics Report for lambda-clamav-layer | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/lambda-clamav-layer/predominant_langs_lambda-clamav-layer_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/lambda-clamav-layer/language_summary_lambda-clamav-layer_data.svg", title: "Language Summary" %}
</div>