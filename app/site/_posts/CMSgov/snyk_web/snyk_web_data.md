---
layout: repo-report
title: Open Source at CMS Metrics Report for snyk_web | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/snyk_web/predominant_langs_snyk_web_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/snyk_web/language_summary_snyk_web_data.svg", title: "Language Summary" %}
</div>