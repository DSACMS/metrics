---
layout: repo-report
title: Open Source at CMS Metrics Report for bcda-app | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/bcda-app/predominant_langs_bcda-app_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/bcda-app/language_summary_bcda-app_data.svg", title: "Language Summary" %}
</div>