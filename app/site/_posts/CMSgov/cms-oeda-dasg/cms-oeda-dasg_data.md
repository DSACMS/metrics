---
layout: repo-report
title: Open Source at CMS Metrics Report for cms-oeda-dasg | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/cms-oeda-dasg/predominant_langs_cms-oeda-dasg_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/cms-oeda-dasg/language_summary_cms-oeda-dasg_data.svg", title: "Language Summary" %}
</div>