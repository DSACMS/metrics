---
layout: repo-report
title: Open Source at CMS Metrics Report for ECTA | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/ECTA/predominant_langs_ECTA_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/ECTA/language_summary_ECTA_data.svg", title: "Language Summary" %}
</div>