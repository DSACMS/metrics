---
layout: repo-report
title: Open Source at CMS Metrics Report for cmscloud-infra-mag-jmeter-aci | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/cmscloud-infra-mag-jmeter-aci/predominant_langs_cmscloud-infra-mag-jmeter-aci_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/cmscloud-infra-mag-jmeter-aci/language_summary_cmscloud-infra-mag-jmeter-aci_data.svg", title: "Language Summary" %}
</div>