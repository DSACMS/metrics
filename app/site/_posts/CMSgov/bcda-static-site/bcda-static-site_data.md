---
layout: repo-report
title: Open Source at CMS Metrics Report for bcda-static-site | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/bcda-static-site/predominant_langs_bcda-static-site_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/bcda-static-site/language_summary_bcda-static-site_data.svg", title: "Language Summary" %}
</div>