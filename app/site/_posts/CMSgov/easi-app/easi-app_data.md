---
layout: repo-report
title: Open Source at CMS Metrics Report for easi-app | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/easi-app/predominant_langs_easi-app_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/easi-app/language_summary_easi-app_data.svg", title: "Language Summary" %}
</div>