---
layout: repo-report
title: Open Source at CMS Metrics Report for oopc-calculations | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/oopc-calculations/predominant_langs_oopc-calculations_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/oopc-calculations/language_summary_oopc-calculations_data.svg", title: "Language Summary" %}
</div>