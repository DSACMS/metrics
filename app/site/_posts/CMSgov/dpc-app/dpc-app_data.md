---
layout: repo-report
title: Open Source at CMS Metrics Report for dpc-app | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/dpc-app/predominant_langs_dpc-app_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/dpc-app/language_summary_dpc-app_data.svg", title: "Language Summary" %}
</div>