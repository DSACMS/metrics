---
layout: repo-report
title: Open Source at CMS Metrics Report for CMCS-DSG-DSS-Oversight | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/CMCS-DSG-DSS-Oversight/predominant_langs_CMCS-DSG-DSS-Oversight_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/CMCS-DSG-DSS-Oversight/language_summary_CMCS-DSG-DSS-Oversight_data.svg", title: "Language Summary" %}
</div>