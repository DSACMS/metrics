---
layout: repo-report
title: Open Source at CMS Metrics Report for AB2D-Libs | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/AB2D-Libs/predominant_langs_AB2D-Libs_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMSgov/AB2D-Libs/language_summary_AB2D-Libs_data.svg", title: "Language Summary" %}
</div>