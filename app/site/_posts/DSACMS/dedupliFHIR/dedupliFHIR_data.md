---
layout: repo-report
title: Open Source at CMS Metrics Report for dedupliFHIR | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/dedupliFHIR/predominant_langs_dedupliFHIR_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/dedupliFHIR/language_summary_dedupliFHIR_data.svg", title: "Language Summary" %}
</div>