---
layout: repo-report
title: Open Source at CMS Metrics Report for open | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/open/predominant_langs_open_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/open/language_summary_open_data.svg", title: "Language Summary" %}
</div>