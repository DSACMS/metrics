---
layout: repo-report
title: Open Source at CMS Metrics Report for .github | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/.github/predominant_langs_.github_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/DSACMS/.github/language_summary_.github_data.svg", title: "Language Summary" %}
</div>