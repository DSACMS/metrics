---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-dynamodb | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMS-Enterprise/batcave-tf-dynamodb/predominant_langs_batcave-tf-dynamodb_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMS-Enterprise/batcave-tf-dynamodb/language_summary_batcave-tf-dynamodb_data.svg", title: "Language Summary" %}
</div>