---
layout: repo-report
title: Open Source at CMS Metrics Report for batcave-tf-cluster | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/CMS-Enterprise/batcave-tf-cluster/predominant_langs_batcave-tf-cluster_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/CMS-Enterprise/batcave-tf-cluster/language_summary_batcave-tf-cluster_data.svg", title: "Language Summary" %}
</div>