...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/CMS-Enterprise/batcave-tf-irsa/issue_gauge_batcave-tf-irsa_data.svg" />
    </figure>
    <!--- Contributor Activity Line Graph -->
    <h3>Commits by Month</h3>
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/CMS-Enterprise/batcave-tf-irsa/commit_sparklines_batcave-tf-irsa_data.svg" />
    </figure>
  </div>
</div>