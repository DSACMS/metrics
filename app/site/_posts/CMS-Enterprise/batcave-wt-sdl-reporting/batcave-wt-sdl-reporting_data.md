...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/CMS-Enterprise/batcave-wt-sdl-reporting/issue_gauge_batcave-wt-sdl-reporting_data.svg" />
    </figure>
    <!--- Contributor Activity Line Graph -->
    <h3>Commits by Month</h3>
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/CMS-Enterprise/batcave-wt-sdl-reporting/commit_sparklines_batcave-wt-sdl-reporting_data.svg" />
    </figure>
  </div>
</div>