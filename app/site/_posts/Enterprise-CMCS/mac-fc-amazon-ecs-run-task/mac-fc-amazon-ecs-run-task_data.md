---
layout: repo-report
title: Open Source at CMS Metrics Report for mac-fc-amazon-ecs-run-task | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-amazon-ecs-run-task/predominant_langs_mac-fc-amazon-ecs-run-task_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-amazon-ecs-run-task/language_summary_mac-fc-amazon-ecs-run-task_data.svg", title: "Language Summary" %}
</div>