---
layout: repo-report
title: Open Source at CMS Metrics Report for managed-care-review | REPORT-2024-10-08
  ...
  <table class="usa-table usa-table--borderless">
    ...
    <tbody>
      <tr>
        ...
        <td style="color: #45c527" >0.048%</td>
      </tr>
      <tr>
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/managed-care-review/predominant_langs_managed-care-review_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/managed-care-review/language_summary_managed-care-review_data.svg", title: "Language Summary" %}
</div>