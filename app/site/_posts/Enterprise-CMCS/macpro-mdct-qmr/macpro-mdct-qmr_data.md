---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-mdct-qmr | REPORT-2024-10-08
  ...
  <table class="usa-table usa-table--borderless">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>1517</td>
        <td style="color: #45c527" >1</td>
        <td style="color: #45c527" >0.066%</td>
      </tr>
      <tr>
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mdct-qmr/predominant_langs_macpro-mdct-qmr_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mdct-qmr/language_summary_macpro-mdct-qmr_data.svg", title: "Language Summary" %}
</div>