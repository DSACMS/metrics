---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-mako | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mako/predominant_langs_macpro-mako_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mako/language_summary_macpro-mako_data.svg", title: "Language Summary" %}
</div>