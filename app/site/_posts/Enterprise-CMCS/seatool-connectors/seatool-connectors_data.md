---
layout: repo-report
title: Open Source at CMS Metrics Report for seatool-connectors | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/seatool-connectors/predominant_langs_seatool-connectors_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/seatool-connectors/language_summary_seatool-connectors_data.svg", title: "Language Summary" %}
</div>