...
<div class="graph-container">
  ...
  <div class="row">
    ...
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/Enterprise-CMCS/seatool-connectors/issue_gauge_seatool-connectors_data.svg" />
    </figure>
    <!--- Contributor Activity Line Graph -->
    <h3>Commits by Month</h3>
    <figure>
      <embed type="image/svg+xml" src="../../assets/img/graphs/Enterprise-CMCS/seatool-connectors/commit_sparklines_seatool-connectors_data.svg" />
    </figure>
  </div>
</div>