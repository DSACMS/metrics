---
layout: repo-report
title: Open Source at CMS Metrics Report for mac-fc-github-actions-runner-aws | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-github-actions-runner-aws/predominant_langs_mac-fc-github-actions-runner-aws_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-github-actions-runner-aws/language_summary_mac-fc-github-actions-runner-aws_data.svg", title: "Language Summary" %}
</div>