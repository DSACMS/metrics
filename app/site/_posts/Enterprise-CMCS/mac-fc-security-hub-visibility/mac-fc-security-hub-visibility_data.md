---
layout: repo-report
title: Open Source at CMS Metrics Report for mac-fc-security-hub-visibility | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-security-hub-visibility/predominant_langs_mac-fc-security-hub-visibility_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/mac-fc-security-hub-visibility/language_summary_mac-fc-security-hub-visibility_data.svg", title: "Language Summary" %}
</div>