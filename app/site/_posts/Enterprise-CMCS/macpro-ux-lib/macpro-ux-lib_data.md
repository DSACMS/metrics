---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-ux-lib | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-ux-lib/predominant_langs_macpro-ux-lib_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-ux-lib/language_summary_macpro-ux-lib_data.svg", title: "Language Summary" %}
</div>