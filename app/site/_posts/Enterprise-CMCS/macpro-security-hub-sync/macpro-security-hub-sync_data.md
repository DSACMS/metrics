---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-security-hub-sync | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-security-hub-sync/predominant_langs_macpro-security-hub-sync_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-security-hub-sync/language_summary_macpro-security-hub-sync_data.svg", title: "Language Summary" %}
</div>