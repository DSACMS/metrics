---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-onemac | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-onemac/predominant_langs_macpro-onemac_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-onemac/language_summary_macpro-onemac_data.svg", title: "Language Summary" %}
</div>