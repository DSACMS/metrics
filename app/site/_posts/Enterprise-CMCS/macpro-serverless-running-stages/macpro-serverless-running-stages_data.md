---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-serverless-running-stages | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-serverless-running-stages/predominant_langs_macpro-serverless-running-stages_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-serverless-running-stages/language_summary_macpro-serverless-running-stages_data.svg", title: "Language Summary" %}
</div>