---
layout: repo-report
title: Open Source at CMS Metrics Report for macpro-mdct-mcr | REPORT-2024-10-08
...
<div class="graph-container">
  ...
  <div class="all-graphs">
    ...
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mdct-mcr/predominant_langs_macpro-mdct-mcr_data.svg", title: "Predominant Languages" %}
    <!-- Language Summary Chart -->
    {% render "graph-section" baseurl: site.baseurl, path: "/Enterprise-CMCS/macpro-mdct-mcr/language_summary_macpro-mdct-mcr_data.svg", title: "Language Summary" %}
</div>